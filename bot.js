...
function changeRainbowRoleHue() {
  ...
  if (guild) {
    createAndFindRole(guild, config.roles.rainbow_role).then((role) => {
      const currentColor = role.color;
      let switchColor = colors[0];
